/*********************************************************************
 *
 * $Id: yocto_api.js 22775 2016-01-15 10:16:10Z mvuilleu $
 *
    ...
    function YModule_get_allSettings()
    {
        ...
        if (this.hasFunction("files")) {
            ...
            for (ii in  filelist) {
                ...
                if ((name).length == 0) {
                    return new Buffer(name, YAPI.defaultEncoding);
                }
        ...
        ext_settings = ext_settings + "]}";
        res = new Buffer("{ \"api\":", YAPI.defaultEncoding) + settings + new Buffer(ext_settings, YAPI.defaultEncoding);
        return res;
    }
