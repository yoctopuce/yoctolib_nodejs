/*********************************************************************
 *
 * $Id: yocto_api.js 18942 2015-01-15 09:23:01Z seb $
 *
...
//--- (end of generated code: YModule class start)
    ...
    function YModule_set_allSettings(settings)
    {
        ...
        for (ii in old_dslist) {
            if(ii=='indexOf') continue; // IE8 Don'tEnum bug
            old_dslist[ii] = this._json_get_string(new Buffer(old_dslist[ii], YAPI.defaultEncoding));
        ...
        for (ii in new_dslist) {
            if(ii=='indexOf') continue; // IE8 Don'tEnum bug
            new_dslist[ii] = this._json_get_string(new Buffer(new_dslist[ii], YAPI.defaultEncoding));
